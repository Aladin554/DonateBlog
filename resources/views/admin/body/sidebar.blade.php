            ...
            <aside class="sidebar-wrapper ">
              <nav class="sidebar-nav">
                 <ul class="metismenu" id="menu1">
                    ...
                    <li class="single-nav-wrapper">
                          <a class="menu-item" href="{{route('slider')}}" aria-expanded="false">
                            <span class="left-icon"><i class="far fa-image"></i></span>
                              <span class="menu-text">Slider</span>
                          </a>
                      </li>
                      <li class="single-nav-wrapper">
                          <a class="menu-item" href="{{route('about')}}" aria-expanded="false">
                            <span class="left-icon"><i class="fas fa-about"></i></span>
                              <span class="menu-text">About</span>
                          </a>
                      </li>
                      <li class="single-nav-wrapper">
                          <a class="menu-item" href="{{route('service')}}" aria-expanded="false">
                            <span class="left-icon"><i class="fas fa-chart-line"></i></span>
                            <span class="menu-text">Services</span>
                          </a>
                      </li>
                      <li class="single-nav-wrapper">
                          <a class="menu-item" href="{{route('donate')}}" aria-expanded="false">
