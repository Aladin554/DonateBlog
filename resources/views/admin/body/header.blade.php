...
<header class="header_area">
                ...
                <div class="sidebar_logo">
                    <a href="index.html" style="font-family: 'Inter';
            font-style: normal;
            
            color: white;
            font-size: 20px;
            line-height: 24px;">
  <img src="{{ asset('panel/assets/images/logo_small2.png') }}" alt="" style="height:35px; width:40px;" class="img-fluid logo1 mt-1 pl-1">
   <p class="pl-5 mt-2">Donate</p>
                    </a>
                </div>
